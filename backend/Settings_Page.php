...
class Settings_Page extends Engine\Base {
	...
	public function add_plugin_admin_menu() {
		 ...
		 *
		 */
		add_menu_page( __( 'MZ Mindbody Classes Settings', MMC_TEXTDOMAIN ), MMC_NAME, 'manage_options', MMC_TEXTDOMAIN, array( $this, 'display_plugin_admin_page' ), 'dashicons-hammer', 90 );
	}
