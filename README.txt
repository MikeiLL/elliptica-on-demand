...
2. Search for 'elliptica-on-demand'
3. Click 'Install Now'
...
3. Select `elliptica-on-demand.zip` from your computer
4. Click 'Install Now'
5. Activate the plugin in the Plugin dashboard

= Using FTP =

1. Download `elliptica-on-demand.zip`
2. Extract the `elliptica-on-demand` directory to your computer
3. Upload the `elliptica-on-demand` directory to the `/wp-content/plugins/` directory
